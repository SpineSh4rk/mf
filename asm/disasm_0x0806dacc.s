...
_0806DB78:
	...
	cmp r0, #0
	beq _0806DBA4
	bl ColorEffectCopyBgPal3AndObjPal2ToPal1
	b _0806DBA8
	.align 2, 0
_0806DBA0: .4byte 0x083C94A0
_0806DBA4:
	bl ColorEffectCopyEwramPal2ToEwramPal1
_0806DBA8:
...
_0806DBDA:
	...
	ldrb r1, [r0]
	adds r0, r6, #0
	bl ColorEffectFadePalette_SkipHud
	b _0806DD0E
_0806DBEA:
	ldrb r3, [r7, #2]
	cmp r3, #0
...
_0806DCF4:
	...
	ldrb r1, [r0]
	adds r0, r6, #0
	bl ColorEffectFadePalette_SkipSamus
_0806DD0E:
	ldrb r0, [r7, #2]
	adds r0, #1
	strb r0, [r7, #2]
...
_0806DDA4:
	bl ColorEffectCopyPalramToEwramPal2
	b _0806DDB2
_0806DDAA:
	adds r0, r3, #0
	adds r1, r4, #0
