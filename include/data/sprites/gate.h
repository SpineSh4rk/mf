...
extern const struct FrameData sGateOam_OpenedWide[2];
extern const struct FrameData sGateOam_ClosingWide[15];
extern const struct FrameData sGateOam_OpeningWide[15];
extern const struct FrameData sGateOam_ClosedWide[19];
